...
# WONN ImageNet-100 script: ch=256, constant channels.
...
#   DATA_ROOT=/path/to/imagenet-100 bash run_imagenet100_ch256.sh
#   COUPLING=conv SI_FUNC=trig DATA_ROOT=/path/to/imagenet-100 bash run_imagenet100_ch256.sh
#
# Important:
...
EXP_NAME=${EXP_NAME:-WONN_imagenet100_${COUPLING}_${SI_FUNC}_ch256}
