...
from image_recognition.imagenet.data import build_dataloaders, IMAGENET_STATS
...
def build_parser():
    parser = argparse.ArgumentParser(description="WONN ImageNet-100 Training")
    ...
    # data
    parser.add_argument("--data_root", type=str, default="./data/imagenet-100")
