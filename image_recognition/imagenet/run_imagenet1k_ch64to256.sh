...
# WONN ImageNet-1K script: ch=64 -> ch_final=256.
...
#   GPUS=4,5,6,7 NPROC=4 DATA_ROOT=/data/imagenet_common bash run_imagenet1k_ch64to256.sh
#   COUPLING=conv SI_FUNC=trig bash run_imagenet1k_ch64to256.sh
#
# Important:
#   - DATA_ROOT must point to the ImageNet-1K root containing train/ and val/.
...
EXP_NAME=${EXP_NAME:-WONN_imagenet1k_${COUPLING}_${SI_FUNC}_ch64to256}
