...
# WONN ImageNet-100 script: ch=64 -> ch=256.
...
#   DATA_ROOT=/path/to/imagenet-100 bash run_imagenet100_ch64to256.sh
#   COUPLING=conv SI_FUNC=trig DATA_ROOT=/path/to/imagenet-100 bash run_imagenet100_ch64to256.sh
#
# Important:
...
EXP_NAME=${EXP_NAME:-WONN_imagenet100_${COUPLING}_${SI_FUNC}_ch64to256}
