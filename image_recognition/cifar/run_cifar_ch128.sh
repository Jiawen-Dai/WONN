...
# WONN CIFAR script: ch=128, constant channels.
...
#   DATA=cifar100 DATA_ROOT=/path/to/data bash run_cifar_ch128.sh
#   COUPLING=conv SI_FUNC=trig DATA_ROOT=/path/to/data bash run_cifar_ch128.sh
#
# Important:
...
EXP_NAME=${EXP_NAME:-WONN_${DATA}_${COUPLING}_${SI_FUNC}_ch128}
